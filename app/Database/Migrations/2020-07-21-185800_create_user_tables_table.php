...
class CreateUserTablesTable extends Migration
{
    public function up() {
        ...
        $this->forge->addField([
            ...
            'pk'               => ['type' => 'tinyint', 'unsigned' => true, 'null' => true],
            'default'          => ['type' => 'tinyint', 'unsigned' => true, 'null' => true],
            'null'             => ['type' => 'tinyint', 'unsigned' => true, 'null' => true],
            'ai'               => ['type' => 'tinyint', 'unsigned' => true, 'null' => true],
            'enabled'          => ['type' => 'tinyint', 'unsigned' => true, 'null' => true],
